...
from glotaran_core import (KineticModel, KineticParameter, IrfParameter,
                           Models, Datasets, GlobalAnalysis)

set1 = SimulatedSpectralTimetrace([1, 2.5], [1e-3, 2e-5], [100, 200], 50, 250,
                                  1, 500, 1, label="set1")
set2 = SimulatedSpectralTimetrace([1, 2.5], [1e-3, 5e-5], [100, 200], 50, 250,
                                  1, 500, 1, label="set2")
