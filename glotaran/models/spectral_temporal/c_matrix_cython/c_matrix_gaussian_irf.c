...
static PyObject *__pyx_pf_21c_matrix_gaussian_irf_2calculateCSingleGaussian(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_C, PyObject *__pyx_v_idxs, __Pyx_memviewslice __pyx_v_k, __Pyx_memviewslice __pyx_v_x, double __pyx_v_mu, double __pyx_v_delta, double __pyx_v_scale, int __pyx_v_backsweep, double __pyx_v_backsweep_period); /* proto */
...
static PyObject *__pyx_pw_21c_matrix_gaussian_irf_3calculateCSingleGaussian(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_C,&__pyx_n_s_idxs,&__pyx_n_s_k,&__pyx_n_s_x,&__pyx_n_s_mu,&__pyx_n_s_delta,&__pyx_n_s_scale,&__pyx_n_s_backsweep,&__pyx_n_s_backsweep_period,0};
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[3]); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 25, __pyx_L3_error)
  ...
  __pyx_r = __pyx_pf_21c_matrix_gaussian_irf_2calculateCSingleGaussian(__pyx_self, __pyx_v_C, __pyx_v_idxs, __pyx_v_k, __pyx_v_x, __pyx_v_mu, __pyx_v_delta, __pyx_v_scale, __pyx_v_backsweep, __pyx_v_backsweep_period);
...
static PyObject *__pyx_pf_21c_matrix_gaussian_irf_2calculateCSingleGaussian(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_C, PyObject *__pyx_v_idxs, __Pyx_memviewslice __pyx_v_k, __Pyx_memviewslice __pyx_v_x, double __pyx_v_mu, double __pyx_v_delta, double __pyx_v_scale, int __pyx_v_backsweep, double __pyx_v_backsweep_period) {
 ...
 */
  __pyx_v_nr_times = (__pyx_v_x.shape[0]);
 ...
 */
    __pyx_t_5 = __Pyx_GetItemInt(__pyx_v_idxs, __pyx_v_n_k, int, 1, __Pyx_PyInt_From_int, 0, 0, 0); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 36, __pyx_L1_error)
 ...
 */
      ...
      __pyx_v_t_n = (*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_10 * __pyx_v_x.strides[0]) )));
 ...
 */
        ...
        __pyx_t_15 = __pyx_v_n_t;
        __pyx_t_16 = __pyx_v_n_c;
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_C.data + __pyx_t_15 * __pyx_v_C.strides[0]) ) + __pyx_t_16 * __pyx_v_C.strides[1]) )) += (__pyx_t_7 / __pyx_t_8);
 ...
 *     nr_times = x.shape[0]
 */
  __pyx_tuple__24 = PyTuple_Pack(22, __pyx_n_s_C, __pyx_n_s_idxs, __pyx_n_s_k, __pyx_n_s_x, __pyx_n_s_mu, __pyx_n_s_delta, __pyx_n_s_scale, __pyx_n_s_backsweep, __pyx_n_s_backsweep_period, __pyx_n_s_nr_times, __pyx_n_s_nr_comps, __pyx_n_s_n_c, __pyx_n_s_n_t, __pyx_n_s_n_k, __pyx_n_s_t_n, __pyx_n_s_k_n, __pyx_n_s_thresh, __pyx_n_s_alpha, __pyx_n_s_beta, __pyx_n_s_x1, __pyx_n_s_x2, __pyx_n_s_x3); if (unlikely(!__pyx_tuple__24)) __PYX_ERR(0, 25, __pyx_L1_error)
