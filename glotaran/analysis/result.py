...
class Result:
    ...
    def markdown(self, with_model=True) -> str:
        ...
        string += f"{self.number_function_evaluation} |".rjust(lr)
        string += "\n"
        string += "Number of variables |".rjust(ll)
        string += f"{self.number_variables} |".rjust(lr)
        string += "\n"
        string += "Number of datapoints |".rjust(ll)
        string += f"{self.number_data_points} |".rjust(lr)
        string += "\n"
        string += "Degrees of freedom |".rjust(ll)
        string += f"{self.degree_of_freedom} |".rjust(lr)
        string += "\n"
