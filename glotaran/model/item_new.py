...
class ModelItem(Item):
    ...
    label: str = Attribute(description="The label of the model item.")
...
def iterate_model_item_fields(item: type[Item]) -> Generator[Field, None, None]:
    """Iterate over all model item fields.
