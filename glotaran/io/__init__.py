...
from glotaran.plugin_system.project_io_registration import load_result_file
...
from glotaran.plugin_system.project_io_registration import save_result_file
